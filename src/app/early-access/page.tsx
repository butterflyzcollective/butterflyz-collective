export default function EarlyAccessPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-5xl px-6 pb-12 pt-4 overflow-hidden">
        <video
          ...
          playsInline
        >
          <source src="/early-access/EARLY%20ACCESS%20HERO%20VIDEO.mov" />
        </video>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <div className="mt-6 overflow-hidden rounded-xl border border-white/10 bg-black">
            <iframe
              ...
              src="https://docs.google.com/forms/d/e/1FAIpQLSceUF5d3gaeTNyoQXi10pukk8Z9-BxoaTrpOzxUy8kPS8bMgA/viewform?embedded=true"
